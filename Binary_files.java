...
public class Main {
    ...
    public static void calculate() {
        ...
        System.out.print("Input number to calculate: ");
        int Calculate;
        try {
            Calculate = Integer.parseInt(sc.nextLine());
        } catch (Exception e) {
        ...
        try (DataInputStream in = new DataInputStream(new FileInputStream(file))) {
            ...
            System.out.println("Hmm pardon" + e.getMessage());
            return;
        }

        try (DataOutputStream out = new DataOutputStream(new FileOutputStream(file))) {
            for (String line : newTxt.toString().split("\n")) {
                if (!line.trim().isEmpty()) {
                    out.writeInt(Integer.parseInt(line.trim()));
                }
            }
        } catch (IOException e) {
